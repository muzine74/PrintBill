...
namespace DBConnection.Migrations
{
    ...
    [Migration("20260117022931_CreationDesEntityWorks")]
    partial class CreationDesEntityWorks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DBConnection.Entity.EmployeeWork", b =>
                {
                    b.Property<Guid>("EmployeeWorkId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EmployeeWorks", t =>
                        {
                            t.HasCheckConstraint("CK_EmployeeWork_Amount", "[Amount] >= 0");

                            t.HasCheckConstraint("CK_EmployeeWork_HoursWorked", "[HoursWorked] > 0");

                            t.HasCheckConstraint("CK_EmployeeWork_Status", "[Status] IN (0, 1, 2, 3, 4)");
                        });
                });
